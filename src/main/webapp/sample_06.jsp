...
<body class="docs framebox_body">
	...
	<script type="text/javascript">
		...
		//마커 아이콘
		var myIcon = new google.maps.MarkerImage("sample1.bmp", null, null,
				null, new google.maps.Size(12, 20));
...
#autocomplete {
	...
	<div id="controls">
		<form name="controls">
			...
			<br /> <input type="radio" name="type" value="subway_station"
				onclick="search()" />지하철 <br /> <input type="radio" name="type"
