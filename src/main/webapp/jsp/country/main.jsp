...
<c:url var="listController" value="/js/country/listController.js"></c:url>
<c:url var="detailController" value="/js/country/detailController.js"></c:url>
<c:url var="appendController" value="/js/country/appendController.js"></c:url>
<c:url var="modifyController" value="/js/country/modifyController.js"></c:url>
<c:url var="deleteController" value="/js/country/deleteController.js"></c:url>
